...
const About = () => {
  ...
  const milestones = [
    {
      year: "2016",
      title: "The Beginning",
      desc: "Three friends founded Sleepy Owl, introducing Cold Brew to India",
    },
    {
      year: "2019",
      title: "Hot Brew Launch",
      desc: "Expanded product line with premium hot brew collections",
    },
    {
      year: "2021",
      title: "Series A Funding",
      desc: "Raised $6.5M to scale operations and expand reach",
    },
    {
      year: "2024",
      title: "Market Leader",
      desc: "Became India's most trusted coffee brand with premium quality",
    },
  ];
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 overflow-hidden"
    >
      <motion.div
        style={{ y: backgroundY }}
      ...
      >
        <div className="text-center max-w-6xl mx-auto">
          ...
          >
            Started by three friends who recognized the gap in the market for
            good quality coffee at home, made with minimal effort, Sleepy Owl's
            vision is to disrupt the at-home coffee industry in India.
          </motion.div>
        </div>
      ...
      <motion.section className="py-24 px-4 relative" style={{ y: parallaxY }}>
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Founded in 2016, Sleepy Owl became the first to introduce India to
              the concept of Cold Brew Coffee, pioneering a new coffee culture.
            </p>
          </motion.div>
              ...
              <div className="relative">
                ...
                <div className="relative bg-white p-8 rounded-2xl shadow-2xl">
                  ...
                  <p className="text-gray-600 text-lg leading-relaxed">
                    To give our customers easy access to the best quality
                    coffee, constantly innovating and redefining the coffee
                    drinking experience with premium instant coffee and cold
                    brew solutions.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="relative">
                ...
                <div className="relative bg-white p-8 rounded-2xl shadow-2xl">
                  ...
                  <p className="text-gray-600 text-lg leading-relaxed">
                    Using state-of-the-art microground technology to create
                    coffee powder that perfectly dissolves in hot or cold water,
                    delivering delicious coffee in seconds.
                  </p>
                </div>
              </div>
            </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl opacity-90">
              Our impact in the Indian coffee market
            </p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Three good friends with one ambitious vision - to bring real good
              coffee to everyone.
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto text-center px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl mb-8 opacity-90">
              Experience the perfect blend of convenience and quality with
              Sleepy Owl Coffee.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
