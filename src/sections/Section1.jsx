      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
        <div className="flex flex-col gap-[2rem] md:gap-[3rem] items-center md:items-start">
          <p className="w-full md:w-[15rem] text-center md:text-left text-sm sm:text-base">
            Born from a passion for exceptional coffee, Sleepy Owl
            revolutionizes your daily brew experience. From our signature cold
            brew to artisanal blends, we bring café-quality coffee to your home
            with innovative brewing methods and premium beans sourced from the
            finest origins.
          </p>
