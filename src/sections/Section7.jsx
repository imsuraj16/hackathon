...
const Section7 = () => {
  ...
  return (
    ...
    >
      ...
      <div
        ref={contentRef}
        className="section7-content relative z-10 text-center max-w-4xl mx-auto px-6"
      >
        <div ref={logoRef} className="section7-logo mb-12 flex justify-center">
          <svg
          ...
          >
            <g transform="translate(169 169)">
              ...
              >
                <text
                  transform="rotate(-90) translate(0, -145)"
                  textAnchor="middle"
                  fill="#f3f4f6"
                >
                  S
                ...
                <text
                  transform="rotate(-78) translate(0, -145)"
                  textAnchor="middle"
                  fill="#f3f4f6"
                >
                  L
                ...
                <text
                  transform="rotate(-66) translate(0, -145)"
                  textAnchor="middle"
                  fill="#f3f4f6"
                >
                  E
                ...
                <text
                  transform="rotate(-54) translate(0, -145)"
                  textAnchor="middle"
                  fill="#f3f4f6"
                >
                  E
                ...
                <text
                  transform="rotate(-42) translate(0, -145)"
                  textAnchor="middle"
                  fill="#f3f4f6"
                >
                  P
                ...
                <text
                  transform="rotate(-30) translate(0, -145)"
                  textAnchor="middle"
                  fill="#f3f4f6"
                >
                  Y
                ...
                <text
                  transform="rotate(-18) translate(0, -145)"
                  textAnchor="middle"
                  fill="#f3f4f6"
                >
                  {" "}
                ...
                <text
                  transform="rotate(-6) translate(0, -145)"
                  textAnchor="middle"
                  fill="#f3f4f6"
                >
                  O
              ...
              >
                ...
                <text
                  transform="rotate(102) translate(0, -145)"
                  textAnchor="middle"
                  fill="#f3f4f6"
                >
                  L
                ...
                <text
                  transform="rotate(114) translate(0, -145)"
                  textAnchor="middle"
                  fill="#f3f4f6"
                >
                  E
                ...
                <text
                  transform="rotate(126) translate(0, -145)"
                  textAnchor="middle"
                  fill="#f3f4f6"
                >
                  E
                ...
                <text
                  transform="rotate(138) translate(0, -145)"
                  textAnchor="middle"
                  fill="#f3f4f6"
                >
                  P
                ...
                <text
                  transform="rotate(150) translate(0, -145)"
                  textAnchor="middle"
                  fill="#f3f4f6"
                >
                  Y
                ...
                <text
                  transform="rotate(162) translate(0, -145)"
                  textAnchor="middle"
                  fill="#f3f4f6"
                >
                  {" "}
                ...
                <text
                  transform="rotate(174) translate(0, -145)"
                  textAnchor="middle"
                  fill="#f3f4f6"
                >
                  O
                ...
                <text
                  transform="rotate(186) translate(0, -145)"
                  textAnchor="middle"
                  fill="#f3f4f6"
                >
                  W
                ...
                <text
                  transform="rotate(198) translate(0, -145)"
                  textAnchor="middle"
                  fill="#f3f4f6"
                >
                  L
              ...
              >
                <text
                  transform="rotate(30) translate(0, -85)"
                  textAnchor="middle"
                  fill="#fed7aa"
                >
                  C
                ...
                <text
                  transform="rotate(60) translate(0, -85)"
                  textAnchor="middle"
                  fill="#fed7aa"
                >
                  O
                ...
                <text
                  transform="rotate(90) translate(0, -85)"
                  textAnchor="middle"
                  fill="#fed7aa"
                >
                  F
                ...
                <text
                  transform="rotate(120) translate(0, -85)"
                  textAnchor="middle"
                  fill="#fed7aa"
                >
                  F
                ...
                <text
                  transform="rotate(150) translate(0, -85)"
                  textAnchor="middle"
                  fill="#fed7aa"
                >
                  E
                ...
                <text
                  transform="rotate(180) translate(0, -85)"
                  textAnchor="middle"
                  fill="#fed7aa"
                >
                  E
                ...
                <text
                  transform="rotate(210) translate(0, -85)"
                  textAnchor="middle"
                  fill="#fed7aa"
                >
                  C
                ...
                <text
                  transform="rotate(240) translate(0, -85)"
                  textAnchor="middle"
                  fill="#fed7aa"
                >
                  O
                ...
                <text
                  transform="rotate(270) translate(0, -85)"
                  textAnchor="middle"
                  fill="#fed7aa"
                >
                  F
                ...
                <text
                  transform="rotate(300) translate(0, -85)"
                  textAnchor="middle"
                  fill="#fed7aa"
                >
                  F
                ...
                <text
                  transform="rotate(330) translate(0, -85)"
                  textAnchor="middle"
                  fill="#fed7aa"
                >
                  E
              ...
              <g transform="translate(0, -10)">
                ...
                <path
                  d="M-20,-30 L-12,-45 L-5,-30 Z"
                  fill="#deb887"
                  stroke="#8b4513"
                  strokeWidth="2"
                />
                <path
                  d="M20,-30 L12,-45 L5,-30 Z"
                  fill="#deb887"
                  stroke="#8b4513"
                  strokeWidth="2"
                />
              ...
              <g opacity="0.7">
                ...
                <ellipse
                  ...
                  ry="6"
                  fill="#8b4513"
                  transform="rotate(30 80 20)"
                />
                <path
                  d="M80,20 Q82,22 80,24"
                  fill="none"
                  stroke="#deb887"
                  strokeWidth="1"
                />
        ...
        <p className="text-xl md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto leading-relaxed">
          ...
          premium cold brew coffee. Crafted for those who never settle for
          ordinary.
        </p>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="group">
            <h3 className="text-4xl font-bold text-amber-400 group-hover:text-amber-300 transition-colors">
              50K+
            </h3>
