    ...
    <footer className="bg-white text-black px-6 py-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <h3 className="font-semibold text-sm mb-4 tracking-wider">
              SLEEPY OWL
            </h3>
            <ul className="space-y-2 text-sm">
              <li>
          ...
          <div>
            ...
            <div className="text-sm space-y-3">
              ...
              <div className="flex space-x-6 pt-2">
                <a href="#" className="font-bold hover:underline tracking-wide">
                  INSTAGRAM
                </a>
                <a href="#" className="font-bold hover:underline tracking-wide">
                  FACEBOOK
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-gray-700 leading-relaxed">
                Subscribe to get updates on new products, brewing tips, and
                exclusive offers. We promise not to spam your inbox - only the
                good stuff! Check our{" "}
